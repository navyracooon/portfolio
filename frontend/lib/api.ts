  ...
  projects: [
    {
      ...
      overview:
        "大学 LMS をモバイルから扱いやすくするためのクライアントアプリ想定。課題、通知、コース導線を整理し、複雑な情報構造を日常的な操作に落とし込むことを重視した。",
    ...
    },
    {
      ...
      overview:
        "数理最適化、制御、シミュレーションの知見を、Web アプリや運用設計と切り離さずに示すためのプロジェクト。研究内容そのものより、問題設定と実装思考を伝えることを重視している。",
    ...
    },
    {
      ...
      overview:
        "Neovim、zsh、tmux などの設定をまとめたリポジトリ。派手な成果物ではないが、毎日の操作効率や思考速度に直接効く領域として扱っている。",
    ...
    },
    {
      ...
      overview:
        "Raspberry Pi 上で Caddy、Docker Compose、Cloudflare DNS を使い、公開用サービスと内部サービスを分離して運用する構成。Headscale の詳細そのものではなく、境界設計と公開範囲の制御を主題にしている。",
