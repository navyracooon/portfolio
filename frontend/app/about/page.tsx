    ...
    <main className="page-shell inner-page">
      <section className="panel detail-panel">
        ...
        <div className="detail-columns">
          ...
          <article className="detail-card">
            <h2>トップページの方針</h2>
            <p>
              初期表示では Welcome テキストと Three.js シーンを中心に置き，説明量を抑えます．各島は about，career，research，projects，server，github，contact に対応し，選択中の島は拡大，ラベル，視覚的な強調によって状態が分かるようにします．
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="panel detail-panel">
        ...
        <div className="timeline-list">
          ...
          <article className="timeline-item">
            ...
            <p>
              Docker Compose，リバースプロキシ，HTTPS，独自ドメインなどの運用経験を説明します．内部 IP，管理 URL，VPN ノード一覧，内部サービス一覧は公開しません．
            </p>
          </article>
      ...
      <section className="panel detail-panel">
        <div className="section-heading">
          ...
          <p className="lede">
            3D 表現を使っていても，操作環境や身体的条件によって情報に到達できない構成にはしません．主要な導線，状態表示，フォーカス表示，motion 設定を個別に扱います．
          </p>
        </div>
        ...
        <div className="detail-columns">
          <article className="detail-card">
            ...
            <ul className="detail-list">
              ...
              <li>リバースプロキシ，HTTPS，独自ドメインの利用</li>
